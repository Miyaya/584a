...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_EXTRACTOR : public BT_DECO_CONDITION
{
public:
    BT_DECO_CONDITION_NOT_ENOUGH_EXTRACTOR(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughExtractor(void* data);
