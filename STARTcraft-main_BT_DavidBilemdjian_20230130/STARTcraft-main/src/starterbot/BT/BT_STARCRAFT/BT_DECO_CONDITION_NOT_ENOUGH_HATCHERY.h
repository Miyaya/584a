...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_HATCHERY : public BT_DECO_CONDITION
{
public:
    BT_DECO_CONDITION_NOT_ENOUGH_HATCHERY(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughHatchery(void* data);
