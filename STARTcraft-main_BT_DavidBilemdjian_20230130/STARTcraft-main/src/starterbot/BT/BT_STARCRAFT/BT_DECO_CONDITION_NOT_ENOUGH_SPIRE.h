...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_SPIRE : public BT_DECO_CONDITION
{
public:
    BT_DECO_CONDITION_NOT_ENOUGH_SPIRE(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughSpire(void* data);
