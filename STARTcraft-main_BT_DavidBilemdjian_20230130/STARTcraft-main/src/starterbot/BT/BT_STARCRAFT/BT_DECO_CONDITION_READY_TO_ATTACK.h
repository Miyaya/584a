...
// 
//--------------------
class BT_DECO_CONDITION_READY_TO_ATTACK : public BT_DECO_CONDITION
{
public:
    BT_DECO_CONDITION_READY_TO_ATTACK(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsReadyToAttack(void* data);
