...
// 
//--------------------
class BT_DECO_CONDITION_READY_TO_BUILD : public BT_DECO_CONDITION
{
public:
    BT_DECO_CONDITION_READY_TO_BUILD(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsReadyToBuild(void* data);
