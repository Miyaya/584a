...
StarterBot::StarterBot()
{
	...
	BWAPI::TilePosition selfLocation = BWAPI::Broodwar->self()->getStartLocation();
	...
	//Build Buildings
	BT_DECO_REPEATER* pBuildBuildingsForeverRepeater = new BT_DECO_REPEATER("RepeatForeverBuildBuildings", pParallelSeq, 0, true, false);
	BT_DECO_CONDITION_READY_TO_BUILD* pNotEnoughBuildings = new BT_DECO_CONDITION_READY_TO_BUILD("NotEnoughBuildings", pBuildBuildingsForeverRepeater);
	BT_ACTION_BUILD* pBuildBuildings = new BT_ACTION_BUILD("BuildBuildings", pNotEnoughBuildings);
	...
	BT_DECO_CONDITION_NOT_ENOUGH_UNITS* pNotEnoughZerglings = new BT_DECO_CONDITION_NOT_ENOUGH_UNITS("NotEnoughZerglings", pTrainingZerglingsForeverRepeater);
	//BT_ACTION_TRAIN_ZERGLING* pTrainZergling = new BT_ACTION_TRAIN_ZERGLING("TrainZergling", pNotEnoughZerglings);
	BT_ACTION_TRAIN_UNITS* pTrainZergling = new BT_ACTION_TRAIN_UNITS("TrainUnits", pNotEnoughZerglings);
